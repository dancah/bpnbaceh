	...
	<div class="col-lg-12">
		<div class="card">
			<div class="d-flex justify-content-between p-3">
				<h5 class="pt-2">Edit Kegiatan</h5>
				<div >
			...
			<div class="card-body">
				<form method="POST" action="<?php echo site_url('kegiatan/save') ?>" class="needs-validation" enctype="multipart/form-data" novalidate>
					<input type="hidden" name="idKegiatan" value="<?= $result['idKegiatan'] ?>">
					...
					<div class="form-group form-row">
						...
						<div class="col-md-10">
							<textarea class="form-control" name="deskripsi" rows="4" required><?= $result['deskripsi'] ?></textarea>
					...
					<div class="form-group form-row">
						...
						<div class="col-md-10">
							<input class="form-control" type="text" name="tanggal" data-provide="datepicker" data-date-autoclose="true" data-date-format="yyyy-mm-dd" value="<?= $result['tanggal'] ?>" required readonly>
					...
					<div class="form-group form-row">
						...
						<div class="col-md-10">
							...
							<p class="m-0 text-monospace small font-weight-bold pt-1">
								<a href="#" class="text-info" data-toggle="popover" data-content="<img class='img-fluid' src='<?=base_url('uploads/media/'.$result['foto'])?>'>" data-html="true" data-trigger="hover"><i class="fa fa-image fa-fw"></i> Gambar sebelumnya</a>
							</p>
						</div>
					</div>
					<div class="form-group form-row">
						...
						<div class="col-md-10">
							<textarea class="form-control" name="alamat" rows="4" required><?= $result['alamat'] ?></textarea>
						...
						<div class="col-md-10">
							...
							<div class="form-row mt-3">
								<div class="col-lg-6">
									...
									<input type="text" name="lat" class="form-control" id="lat" value="<?= $result['lat'] ?>" />
								</div>
								<div class="col-lg-6">
									<label>Longitude</label>
									<input type="text" name="lng" class="form-control" id="lng" value="<?= $result['lng'] ?>" />
								</div>
							</div>
						</div>
					</div>
...
<script type="text/javascript">
	function addMapPicker() {
		var mapCenter = [<?=$result['lat'] ?>, <?=$result['lng'] ?>];
		var map = L.map('map', {
			center: [4.61, 96.56],
			zoom: 8,
