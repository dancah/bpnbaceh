		...
		<div class="card">
			...
			<div class="card-body">
				<form method="POST" action="<?php echo site_url('galeri/save') ?>" class="needs-validation" novalidate>
					<input type="hidden" name="idGallery" value="<?php echo $result['idGallery'] ?>">
					<div class="form-group form-row">
						<label class="col-form-label col-md-2">Judul</label>
						<div class="col-md-10">
							<input class="form-control" type="text" name="judul" value="<?php echo $result['judul'] ?>" required="">
					...
					<div class="form-group form-row">
						...
						<div class="col-md-10">
							<textarea class="form-control" name="deskripsi" rows="4" required=""><?php echo $result['deskripsi'] ?></textarea>
					...
					<div class="form-group form-row">
						...
						<div class="col-md-10">
							<input class="form-control" type="text" name="url"  value="<?php echo $result['url'] ?>" required="">
